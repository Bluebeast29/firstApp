...
public class ERPModulesActivity extends AppCompatActivity {
    ...
    private void setupClickListeners() {
        findViewById(R.id.btn_departments).setOnClickListener(v ->
                startActivity(new Intent(this, DepartmentListActivity.class)));

        findViewById(R.id.btn_courses).setOnClickListener(v ->
                startActivity(new Intent(this, CourseListActivity.class)));

        findViewById(R.id.btn_students).setOnClickListener(v ->
                startActivity(new Intent(this, StudentListActivity.class)));

        findViewById(R.id.btn_faculty).setOnClickListener(v ->
